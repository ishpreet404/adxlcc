'use strict';
/**
 * Seismic feature extractor — Node.js port of ml/features.py.
...
function extract(signal, fs = 100) {
  ...
  let sumSq = 0, mn = Infinity, mx = -Infinity, maxAbs = 0;
  for (let i = 0; i < n; i++) {
  ...
  let domFreq = 0, maxMag = -1, energy = 0, wsum = 0, msum = 0;
...
module.exports = { FEATURE_ORDER, extract, spectrum, toVector, fftMagnitudes };
