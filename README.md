...
| `ml/` | Pure-Python trainer (no numpy/sklearn): synthetic seismic generator, random forest + logistic regression, exports JSON for the server and a C header for the ESP32; real-data recording loop | 97.8 % held-out |
